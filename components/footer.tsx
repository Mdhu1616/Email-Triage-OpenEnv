        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link href="#tasks" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                  Task Overview
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link href="https://huggingface.co/spaces" target="_blank" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                  Hugging Face Spaces
                </Link>
              </li>
              <li>
                <Link href="https://docker.com" target="_blank" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                  Docker Hub
                </Link>
              </li>
              <li>
                <Link href="https://pypi.org" target="_blank" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                  PyPI Package
                </Link>
              </li>
            </ul>
