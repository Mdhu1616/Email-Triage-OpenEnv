const features = [
  {
    title: "Typed Pydantic Models",
    description: "All observations, actions, and rewards use strict Pydantic models for type safety and validation.",
    icon: CodeIcon,
  },
  {
    title: "Deterministic Seeding",
    description: "Every run is reproducible with configurable random seeds for consistent benchmarking.",
    icon: SeedIcon,
  },
  {
  ...
  {
    title: "Composite Grading",
    description: "Multi-factor scoring with accuracy, efficiency, and penalty components.",
    icon: GradeIcon,
  },
  {
    title: "YAML Configuration",
    description: "Declarative task definitions with metadata, parameters, and grader specifications.",
    icon: ConfigIcon,
  },
]
...
export function FeaturesSection() {
  return (
    <section id="features" className="border-t border-border bg-card/30 py-24 lg:py-32">
